...
func (in *Content) DeepCopyInto(out *Content) {
	*out = *in
	...
	if in.PluginEntities != nil {
		in, out := &in.PluginEntities, &out.PluginEntities
		*out = make([]FPluginEntity, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FPluginEntity) DeepCopyInto(out *FPluginEntity) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FPluginEntity.
func (in *FPluginEntity) DeepCopy() *FPluginEntity {
	if in == nil {
		return nil
	}
	out := new(FPluginEntity)
	in.DeepCopyInto(out)
	return out
}
