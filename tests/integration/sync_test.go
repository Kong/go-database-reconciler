...
// 			kongFile: "testdata/sync/049-cloned-plugin-definitions/kong.yaml",
// 			expectedState: utils.KongRawState{
...
// 			kongFile: "testdata/sync/049-cloned-plugin-definitions/kong-fake.yaml",
// 			wantErr:  true,
// 		},
// 	}
...
// 			err := sync(tc.kongFile, "--include-plugin-definitions")
// 			if tc.wantErr {
// 				require.Error(t, err)
// 				return
// 			}
