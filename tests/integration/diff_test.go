...
func Test_Diff_PluginConfigReorderArraySetValues(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			initialStateFile: "testdata/diff/004-plugin-update/initial-kafka-log-reorder-set.yaml",
			stateFile:        "testdata/diff/004-plugin-update/final-kafka-log-reorder-set.yaml",
