...
// 			initialFile: "testdata/apply/008-cloned-plugin-definitions/initial-cpd-only.yaml",
// 			updateFile:  "testdata/apply/008-cloned-plugin-definitions/update-cpd.yaml",
// 			expectedState: utils.KongRawState{
...
// 			initialFile: "testdata/apply/008-cloned-plugin-definitions/initial-with-plugins.yaml",
// 			updateFile:  "testdata/apply/008-cloned-plugin-definitions/update-plugin-config.yaml",
// 			expectedState: utils.KongRawState{
// 				ClonedPluginDefinitions: []*kong.ClonedPluginDefinition{
// 					{Name: kong.String("new-acl"), Ref: kong.String("acl"), Priority: kong.Uint64(1000), Tags: kong.StringSlice("tag1", "tag2")},
...
// 			})
// 			require.NoError(t, sync(tc.initialFile, "--include-plugin-definitions"))
// 			require.NoError(t, apply(tc.updateFile, "--include-plugin-definitions"))
